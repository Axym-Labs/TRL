...
Temporal Regularized Learning (TeReL) is a highly local and self-supervised prodecure that optimizes
...
TeReL and its simplified variant, TeReL-S. Experiments on MNIST show TeReL is competetive with
backpropagation, Forward-Forward and Equilibrium Propagation, while TeReL-S achieves similar
performance despite its simplified setup. We show TeReL creates neurons with specialized receptive
