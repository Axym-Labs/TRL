...
def render_validation_appendix_latex(validation, confirmatory):
    ...
    return "\n".join(
        [
            ...
            r"\centering",
            r"\small",
            r"\caption{Local SupCon validation grid across three seeds. Bold marks the configuration selected before test evaluation.}",
            ...
            *candidate_rows,
            ...
            r"\centering",
            r"\small",
            r"\caption{Local SupCon test values and resource state across five seeds. Inference retains the encoder parameters and BatchNorm buffers; optimizer state is used only during training.}",
